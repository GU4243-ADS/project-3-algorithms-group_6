...
```{r}
# MS weight data are in GitHub repo, but movie weight data are too large to be uploaded to GitHub, so we uploaded them to GoogleDrive. The Google Drive Link is: https://drive.google.com/open?id=1EMPXV5k9NDRp8rNTJtxVmImtkYaH72Pr
...
```{r}
# Again, MS prediction data are in GitHub repo, but movie weight data are in Google Drive. The Google Drive Link is: https://drive.google.com/open?id=1EMPXV5k9NDRp8rNTJtxVmImtkYaH72Pr
